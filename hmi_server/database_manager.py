...
class DatabaseManager:
        ...
        try:
            ...
            for car_type_info in car_types_data:
                ...
                for ecu_id in ecu_ids:
                    ...
                    if ecu_info:
                        ...
                        for version_id in version_ids:
                            version_info = self.versions_collection.find_one(
                                {"_id": version_id})
                ...
                car_types.append(CarType(
                    ...
                    ecus=ecus,
                    manufactured_count=car_type_info.get(
    ...
    def update_download_request_status(self, car_id: str, status, transferred_size=None):
        ...
        try:
            ...
            print(
                f"Error updating download request status in MongoDB: {str(e)}")
